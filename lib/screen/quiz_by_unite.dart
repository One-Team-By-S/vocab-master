...
import 'package:vocab_master/bloc/vocabluary/getvocabluary_bloc.dart';
...
class QuizByUnite extends StatefulWidget {
  const QuizByUnite({super.key});

  @override
  State<QuizByUnite> createState() => _QuizByUniteState();
}

class _QuizByUniteState extends State<QuizByUnite> {
                ...
                onPressed: () {
                  ...
                  if (currentUnit != null) {
                    ...
                    final newWord = HiveVocabluaryModel(
                      ...
                      date:
                          DateTime.now()
                              .toIso8601String(), // To'g'ri formatlash
                    );
                  ...
                  ScaffoldMessenger.of(
                    context,
                  ).showSnackBar(const SnackBar(content: Text('Word Added!')));
                },
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  if (currentUnit != null) {
                    ...
                    if (uzWords.length > wordIndex)
                      uzWords[wordIndex] = updatedUz;
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('All words have been deleted!'),
                    ),
                  );
                },
                style: ElevatedButton.styleFrom(
